...
#define GVIR_TYPE_CONFIG_DOMAIN_MEMBALLOON            (gvir_config_domain_memballoon_get_type ())
#define GVIR_CONFIG_DOMAIN_MEMBALLOON(obj)            (G_TYPE_CHECK_INSTANCE_CAST ((obj), GVIR_TYPE_CONFIG_DOMAIN_MEMBALLOON, GVirConfigDomainMemballoon))
#define GVIR_CONFIG_DOMAIN_MEMBALLOON_CLASS(klass)    (G_TYPE_CHECK_CLASS_CAST ((klass), GVIR_TYPE_CONFIG_DOMAIN_MEMBALLOON, GVirConfigDomainMemballoonClass))
#define GVIR_IS_CONFIG_DOMAIN_MEMBALLOON(obj)         (G_TYPE_CHECK_INSTANCE_TYPE ((obj), GVIR_TYPE_CONFIG_DOMAIN_MEMBALLOON))
#define GVIR_IS_CONFIG_DOMAIN_MEMBALLOON_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE ((klass), GVIR_TYPE_CONFIG_DOMAIN_MEMBALLOON))
#define GVIR_CONFIG_DOMAIN_MEMBALLOON_GET_CLASS(obj)  (G_TYPE_INSTANCE_GET_CLASS ((obj), GVIR_TYPE_CONFIG_DOMAIN_MEMBALLOON, GVirConfigDomainMemballoonClass))
