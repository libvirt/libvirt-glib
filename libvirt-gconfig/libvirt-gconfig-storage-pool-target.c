...
#define GVIR_CONFIG_STORAGE_POOL_TARGET_GET_PRIVATE(obj)                         \
        (G_TYPE_INSTANCE_GET_PRIVATE((obj), GVIR_TYPE_CONFIG_STORAGE_POOL_TARGET, GVirConfigStoragePoolTargetPrivate))
...
G_DEFINE_TYPE(GVirConfigStoragePoolTarget, gvir_config_storage_pool_target, GVIR_TYPE_CONFIG_OBJECT);
                                                                          ...
                                                                          GError **error)
{
    ...
    object = gvir_config_object_new_from_xml(GVIR_TYPE_CONFIG_STORAGE_POOL_TARGET,
                                             "target", NULL,
                                             xml, error);
    return GVIR_CONFIG_STORAGE_POOL_TARGET(object);
}
