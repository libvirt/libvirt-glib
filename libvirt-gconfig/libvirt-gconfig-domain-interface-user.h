...
#define GVIR_TYPE_CONFIG_DOMAIN_INTERFACE_USER            (gvir_config_domain_interface_user_get_type ())
#define GVIR_CONFIG_DOMAIN_INTERFACE_USER(obj)            (G_TYPE_CHECK_INSTANCE_CAST ((obj), GVIR_TYPE_CONFIG_DOMAIN_INTERFACE, GVirConfigDomainInterfaceUser))
#define GVIR_CONFIG_DOMAIN_INTERFACE_USER_CLASS(klass)    (G_TYPE_CHECK_CLASS_CAST ((klass), GVIR_TYPE_CONFIG_DOMAIN_INTERFACE, GVirConfigDomainInterfaceUserClass))
#define GVIR_IS_CONFIG_DOMAIN_INTERFACE_USER(obj)         (G_TYPE_CHECK_INSTANCE_TYPE ((obj), GVIR_TYPE_CONFIG_DOMAIN_INTERFACE))
#define GVIR_IS_CONFIG_DOMAIN_INTERFACE_USER_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE ((klass), GVIR_TYPE_CONFIG_DOMAIN_INTERFACE))
#define GVIR_CONFIG_DOMAIN_INTERFACE_USER_GET_CLASS(obj)  (G_TYPE_INSTANCE_GET_CLASS ((obj), GVIR_TYPE_CONFIG_DOMAIN_INTERFACE, GVirConfigDomainInterfaceUserClass))
