...
#define GVIR_TYPE_CONFIG_DOMAIN_INTERFACE_BRIDGE            (gvir_config_domain_interface_bridge_get_type ())
#define GVIR_CONFIG_DOMAIN_INTERFACE_BRIDGE(obj)            (G_TYPE_CHECK_INSTANCE_CAST ((obj), GVIR_TYPE_CONFIG_DOMAIN_INTERFACE, GVirConfigDomainInterfaceBridge))
#define GVIR_CONFIG_DOMAIN_INTERFACE_BRIDGE_CLASS(klass)    (G_TYPE_CHECK_CLASS_CAST ((klass), GVIR_TYPE_CONFIG_DOMAIN_INTERFACE, GVirConfigDomainInterfaceBridgeClass))
#define GVIR_IS_CONFIG_DOMAIN_INTERFACE_BRIDGE(obj)         (G_TYPE_CHECK_INSTANCE_TYPE ((obj), GVIR_TYPE_CONFIG_DOMAIN_INTERFACE))
#define GVIR_IS_CONFIG_DOMAIN_INTERFACE_BRIDGE_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE ((klass), GVIR_TYPE_CONFIG_DOMAIN_INTERFACE))
#define GVIR_CONFIG_DOMAIN_INTERFACE_BRIDGE_GET_CLASS(obj)  (G_TYPE_INSTANCE_GET_CLASS ((obj), GVIR_TYPE_CONFIG_DOMAIN_INTERFACE, GVirConfigDomainInterfaceBridgeClass))
